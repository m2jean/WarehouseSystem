...
public class CheckOutPO implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -68734343884814532L;
	private String id;
	...
	public CheckOutPO(String id,String customer,String name,String me,ArrayList<ListInPO> list,double total,String date,Status status,String remark,boolean hong){
		this.id=id;
		this.customer=customer;
		this.name=name;
		this.me=me;
	...
	public CheckOutVO toVO(){
		...
		CheckOutVO vo=new CheckOutVO(id,customer,name,me,d,total,date,status,remark,isHong);
		return vo;
	}
