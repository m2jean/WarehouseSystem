...
public class CheckInVO implements CheckInOutVO{
	private String id;
	...
	public CheckInVO(String id,String customer,String name,String me,ArrayList<ListInVO> list,double total,String date,Status status,String Remark){
		this.id=id;
		this.customer=customer;
		this.name=name;
		this.me=me;
	...
	public CheckInVO(String id,String customer,String name,String me,ArrayList<ListInVO> list,double total,String date,Status status,String Remark,boolean hong){
		this.id=id;
		this.customer=customer;
		this.name=name;
		this.me=me;
	...
	public CheckInPO toPO(){
		...
		CheckInPO po=new CheckInPO(id,customer,name,me,d,total,date,status,remark,isHong);
		return po;
	}
